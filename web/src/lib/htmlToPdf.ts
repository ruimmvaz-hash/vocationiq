...
// DESVIO do pedido: "puppeteer" (com Chromium completo embutido,
...
//
// NOTA HONESTA: não foi possível testar isto numa função serverless real
// da Vercel nesta sessão (só corre localmente). Se a geração automática
// falhar em produção por qualquer razão do ambiente Lambda, o fluxo de
// "Aprovar e enviar" cai sempre para o upload manual (ver
// MarcarEntregueButton.tsx) — nunca fica bloqueado.
